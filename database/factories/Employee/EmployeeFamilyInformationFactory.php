...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Employee\EmployeeFamilyInformation>
 */
class EmployeeFamilyInformationFactory extends Factory
{
    /**
     ...
     */
    protected $model = EmployeeFamilyInformation::class;
